---
name: release-prep
description: Prepare a Renma release by checking git history, changelog, package metadata, docs, release notes, and Renma CLI reports. Use for producing release-ready artifacts. Do not use for distribution or remote changes unless separately requested.
metadata:
