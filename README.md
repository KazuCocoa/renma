...
metadata such as `network_allowed`, `external_upload_allowed`, `secrets_allowed`,
and `approved_network_destinations`; reports contradictory or violated policy;
flags sensitive file and secret-material instructions; and detects external
uploads, unapproved destinations, bulk sharing, cloud upload, overbroad context
