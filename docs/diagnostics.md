...
| `warning` | `Asset is missing an owner.`                                                                      | A cataloged asset has no declared owner metadata.                                                                               | If ownership matters for this repository, choose an `owner` through human review or team policy.                 |
