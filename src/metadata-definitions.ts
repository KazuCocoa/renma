...
export const CANONICAL_SKILL_METADATA_KEYS = {
  ...
  requires_skill: "renma.requires-skill",
  optional_skill: "renma.optional-skill",
...
export const RENMA_CATALOG_METADATA_DEFINITIONS = [
  ...
  {
    operationalField: "requiresSkill",
    skillKey: CANONICAL_SKILL_METADATA_KEYS.requires_skill,
    nonSkillKey: NON_SKILL_CATALOG_METADATA_KEYS.requires_skill,
  },
  {
    operationalField: "optionalSkill",
    skillKey: CANONICAL_SKILL_METADATA_KEYS.optional_skill,
    nonSkillKey: NON_SKILL_CATALOG_METADATA_KEYS.optional_skill,
  },
  {
...
export const NON_SKILL_LIST_METADATA_KEYS = [
  ...
  NON_SKILL_CATALOG_METADATA_KEYS.requires_skill,
  NON_SKILL_CATALOG_METADATA_KEYS.optional_skill,
