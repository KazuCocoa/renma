...
export const COMMAND_HELP = [
  ...
  },
  {
    ...
    purpose:
      "Guide prints a deterministic, non-editing authoring contract before generation. In Renma 0.19.0, skill is the only supported topic.",
    useWhen: [
    ...
    doNotUseFor: [
      "Calling an LLM, accepting a natural-language task, or designing the Skill automatically.",
    ...
    interpretation: [
      ...
      "The guide establishes Renma boundaries; platform-native Skill guidance may refine semantics only within them.",
    ],
    nextSteps: [
      "Define the smallest non-redundant asset graph and retain unresolved human decisions.",
  ...
  },
  {
    ...
    interpretation: [
      ...
      "For Skills, first use renma guide skill to establish the smallest asset graph and repository boundaries; use platform-native guidance only to refine semantics within those boundaries.",
  ...
  },
  {
    ...
    interpretation: [
      ...
      "For Skills, metadata review is only one part of authoring review; after Renma establishes repository boundaries, use platform-native Skill guidance for the trigger description, instructions, workflow, constraints, and completion criteria.",
    ],
    nextSteps: [
...
export function renderGlobalHelp(version: string): string {
  return [
    ...
    "  use platform-native Skill guidance to refine semantics within Renma boundaries",
