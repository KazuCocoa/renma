...
export const COMMAND_HELP = [
  ...
  },
  {
    ...
    purpose:
      "Guide prints a deterministic, non-editing authoring contract before generation or an intentional asset-boundary redesign. In Renma 0.19.0, skill is the only supported topic.",
    useWhen: [
  ...
  },
  {
    ...
    interpretation: [
      ...
      "For Skills, first use renma guide skill to establish the smallest asset structure and repository boundaries; use platform-native guidance only to refine semantics within those boundaries.",
  ...
  },
  {
    ...
    interpretation: [
      ...
      "For Skills, metadata review is only one part of authoring review; use platform-native Skill guidance for the trigger description, instructions, workflow, constraints, and completion criteria.",
    ],
    nextSteps: [
