...
export const COMMAND_HELP = [
  ...
  },
  {
    ...
    purpose:
      "Guide prints a deterministic, non-editing protocol that tells a consuming LLM to clarify human truth before generation or an intentional asset-boundary redesign. Skill is the only supported topic.",
    useWhen: [
