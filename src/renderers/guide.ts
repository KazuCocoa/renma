...
export function renderSkillGuidePrompt(
  ...
  return [
    ...
    "",
    "Complete reference",
    "Use `renma guide skill --format json` for the deterministic complete structured reference, including adaptive activities, conditional external-traversal guidance, the handoff template, and non-normative illustrations. Those reference details do not prescribe the consuming LLM's internal reasoning algorithm.",
    "",
...
function renderCoreInteraction(
  ...
  return [
    ...
    "",
    "Platform-native semantic authoring:",
