  ...
  return {
    ...
    handoff: {
      ...
      rules: [
        ...
        "A structurally valid handoff does not prove that its supporting evidence remains applicable. If repository or external-source state may have materially changed since clarification, recheck only the evidence relevant to pending authoring decisions before scaffolding or semantic authoring, and re-enter the creation gate when the change affects the Skill contract, source authority, security decisions, runtime-unknown handling, or asset boundaries.",
    ...
    interaction: {
      ...
      phases: [
        ...
        "Finish with human review supported by a compact summary of material non-obvious decisions, their governing evidence or authority, the consequence of changing them, and remaining non-blocking uncertainty. Do not claim that the reviewer understood, approved, or independently verified them.",
      ],
      truthSources: [
        ...
        "Generated and derived artifacts: previous plans, summaries, visualizations, review comments, and agent output may help locate questions and evidence, but their generated origin, detail, or prior use does not make their claims current or authoritative. Confirm material claims through the applicable governed source unless the project has explicitly reviewed and designated the derived artifact itself as authoritative. When it conflicts with applicable evidence, preserve the conflict and determine the governing authority instead of choosing by recency, detail, or model confidence alone.",
