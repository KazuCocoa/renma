  ...
  return {
    ...
    interaction: {
      ...
      truthSources: [
        ...
        "Generated and derived artifacts: Renma-generated reports, test results, logs, diagnostics, machine-generated review summaries or comments, external-review artifacts, and other derived output may confirm bounded observations made by an identified producer when provenance, subject, scope, applicability, and currentness are clear. This evidentiary value does not make the artifact governing authority for domain behavior, policy, completeness, or safety. Generation, detail, prior use, or a favorable result alone does not make derived claims authoritative. Confirm claims beyond the artifact's supported evidence boundary through the applicable truth source. Preserve conflicts and determine governing authority instead of choosing by recency, detail, or model confidence alone. An authorized human's explicit decision retains the semantics of an explicit user statement regardless of medium.",
